...
func simulate(hero_stats: CombatStats, mob_stats: CombatStats, random_number_generator: RandomNumberGenerator = null, hero_damage_multiplier: float = 1.0, power_strike_skill_level: int = 0, hero_wisdom: int = 5, battle_guard_skill_level: int = 0, mob_damage_type: String = "physical"):
