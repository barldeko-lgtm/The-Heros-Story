...
func resolve(hero_state, include_temporary_effects: bool = true, equipment_override = null) -> RefCounted:
	...
	combat_stats.fire_resistance = hero_progression.BASE_FIRE_RESISTANCE + equipment.get_fire_resistance_bonus()
	combat_stats.cold_resistance = hero_progression.BASE_COLD_RESISTANCE + equipment.get_cold_resistance_bonus()
	combat_stats.lightning_resistance = hero_progression.BASE_LIGHTNING_RESISTANCE + equipment.get_lightning_resistance_bonus()
