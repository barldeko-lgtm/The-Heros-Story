...
func _init() -> void:
	...
	assert(is_equal_approx(starting_stats.fire_resistance, 10.0), "Starting Warrior must have 10% base Fire Resistance before equipment.")
	assert(is_equal_approx(starting_stats.cold_resistance, 10.0), "Starting Warrior must have 10% base Cold Resistance before equipment.")
	assert(is_equal_approx(starting_stats.lightning_resistance, 10.0), "Starting Warrior must have 10% base Lightning Resistance before equipment.")
