...
func _init() -> void:
	...
	assert(ordinary_power >= 139.0 and ordinary_power <= 141.0, "Mine Troglodyte Power must remain approximately 140; got %.2f." % ordinary_power)
	...
	assert(boss_power >= 179.0 and boss_power <= 181.0, "Deep Devourer Power must remain approximately 180; got %.2f." % boss_power)
	...
	assert(second_ordinary_power >= 229.0 and second_ordinary_power <= 231.0, "Blackfang Guard Power must remain approximately 230; got %.2f." % second_ordinary_power)
	...
	assert(second_boss_power >= 299.0 and second_boss_power <= 301.0, "Goblin King Power must remain approximately 300; got %.2f." % second_boss_power)
