...
const MOB_CONTENT := [
	...
	{"file": "0110_fire_salamander.tres", "id": "fire_salamander", "power": 456.0, "damage_type": "fire", "attack": 144.0},
	{"file": "0111_storm_shaman.tres", "id": "storm_shaman", "power": 478.0, "damage_type": "lightning", "attack": 166.0},
	{"file": "0112_cave_ogre.tres", "id": "cave_ogre", "power": 500.0},
	{"file": "0113_road_bandit_chief.tres", "id": "road_bandit_chief", "power": 523.0},
	{"file": "0114_ice_monitor_lizard.tres", "id": "ice_monitor_lizard", "power": 547.0, "damage_type": "cold", "attack": 143.0},
	...
	{"file": "0118_orc_shaman.tres", "id": "orc_shaman", "power": 651.0, "damage_type": "lightning", "attack": 211.0},
	{"file": "0119_fire_elemental.tres", "id": "fire_elemental", "power": 679.0, "damage_type": "fire", "attack": 210.0},
	{"file": "0120_storm_lizard.tres", "id": "storm_lizard", "power": 708.0, "damage_type": "lightning", "attack": 189.0},
	{"file": "0121_troll_veteran.tres", "id": "troll_veteran", "power": 738.0},
	{"file": "0122_black_knight.tres", "id": "black_knight", "power": 769.0},
	{"file": "0123_ice_elemental.tres", "id": "ice_elemental", "power": 801.0, "damage_type": "cold", "attack": 217.0},
...
func _init() -> void:
	...
	for index in MOB_CONTENT.size():
		...
		assert(absf(mob_power - float(content["power"])) <= 1.0, "Arden mob Power must stay within 1 point of its approved baseline curve: %s target=%.2f actual=%.2f" % [mob.id, content["power"], mob_power])
		if expected_damage_type == "physical":
			...
			var physical_baseline_power: float = load("res://scripts/combat/power_calculator.gd").new().calculate(mob.get_combat_stats(), "physical", "physical")
