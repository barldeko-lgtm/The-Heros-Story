...
const MOB_CONTENT := [
	...
	{"file": "0110_fire_salamander.tres", "id": "fire_salamander", "power": 456.0},
	{"file": "0111_storm_shaman.tres", "id": "storm_shaman", "power": 478.0},
	{"file": "0112_cave_ogre.tres", "id": "cave_ogre", "power": 500.0},
	{"file": "0113_road_bandit_chief.tres", "id": "road_bandit_chief", "power": 523.0},
	{"file": "0114_ice_monitor_lizard.tres", "id": "ice_monitor_lizard", "power": 547.0},
	{"file": "0115_orc_guard.tres", "id": "orc_guard", "power": 572.0},
	{"file": "0116_battle_mage_mercenary.tres", "id": "battle_mage_mercenary", "power": 598.0},
	{"file": "0117_stone_golem.tres", "id": "stone_golem", "power": 624.0},
	{"file": "0118_orc_shaman.tres", "id": "orc_shaman", "power": 651.0},
	{"file": "0119_fire_elemental.tres", "id": "fire_elemental", "power": 679.0},
	{"file": "0120_storm_lizard.tres", "id": "storm_lizard", "power": 708.0},
	{"file": "0121_troll_veteran.tres", "id": "troll_veteran", "power": 738.0},
	{"file": "0122_black_knight.tres", "id": "black_knight", "power": 769.0},
	{"file": "0123_ice_elemental.tres", "id": "ice_elemental", "power": 801.0},
...
func _init() -> void:
	...
	for index in MOB_CONTENT.size():
		...
		assert(absf(mob_power - float(content["power"])) <= 1.0, "Arden mob Power must stay within 1 point of its approved curve: %s target=%.2f actual=%.2f" % [mob.id, content["power"], mob_power])
		assert(mob_power > previous_power, "Arden mob Power must remain strictly increasing: %s" % mob.id)
	...
	print("PASS: Arden 0101-0126 mobs follow the approved 300-to-900 non-linear Power curve with distinct combat profiles.")
	quit()
